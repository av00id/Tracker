...
final class TrackerFormViewController: UIViewController {
    ...
    private var parametersTableView: UITableView = {
    ...
    init(formType: TrackerFormViewController.FormType,
...
extension TrackerFormViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let listCell = tableView.dequeueReusableCell(withIdentifier: ListCell.identifier) as? ListCell else { return UITableViewCell() }
